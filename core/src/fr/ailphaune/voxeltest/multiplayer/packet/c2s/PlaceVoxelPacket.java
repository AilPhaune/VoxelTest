...
public class PlaceVoxelPacket extends Packet<PlaceVoxelPacket.Data> {
	
	public PlaceVoxelPacket() {
		super("PlaceVoxelPacket");
	}
	...
	public static class Data implements Packet.PacketData {
		...
		@Override
		public PlaceVoxelPacket getPacket() {
			return Packets.PLACE_VOXEL;
		}
	}
}